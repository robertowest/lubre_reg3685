...
class Compra:
    ...
    def __init__(self, fecha, comprob, terminal, numero,
        ...
        self.__cuit = cuit[0:13].strip()
        self.__nombre = nombre[0:30]
        self.__neto = abs(round(float(neto), 2))
        self.__no_grab = abs(round(float(no_grab), 2))
        self.__iva21 = abs(round(float(iva21), 2))
        self.__iva10 = abs(round(float(iva10), 2))
        self.__iva27 = abs(round(float(iva27), 2))
        self.__p_ibb = abs(round(float(p_ibb), 2))
        self.__p_iva = abs(round(float(p_iva), 2))
        self.__itc = abs(round(float(itc), 2))
        self.__total = abs(round(float(total), 2))
        self.__c_ali = c_ali
        self.recalcular()
    ...
    def recalcular(self):
        ...
        no_grab = total - round(neto + iva + otros, 2)
        if no_grab != 0:
